package com.developer.portfolio.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.developer.portfolio.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.developer.portfolio.security.DomainUserDetailsService", "createSpringSecurityUser");
